...
COMPONENT_CONTRACTS = {
    "bleed-split": {"use_when": "文字与一张可出血的主视觉共同表达判断；按主体位置选择左右出血。", "variants": ("media-right", "media-left", "default"), "decorations": ("none",)},
    "browser-showcase": {"use_when": "真实界面截图或明确标注的 UI 演示是主要证据；按讲述顺序选择界面在左或右。", "variants": ("media-right", "media-left", "default"), "decorations": ("none",)},
    "card-trio": {"use_when": "三个可独立拿走的信息单元共同支撑一个判断，并且有一主两辅；左右型强调纵向主卡，feature-top 先给总领再读两项支撑。", "variants": ("feature-left", "feature-right", "feature-top"), "decorations": ("none",)},
    "comparison": {"use_when": "两个对象需要以相同维度直接对照。", "variants": ("default",), "decorations": ("none", "dots", "corner-grid")},
    "comparison-list": {
    ...
    "diagonal-split": {"use_when": "章节转折或冲突需要更强的方向感，并有一张主视觉；斜切方向应跟随内容动势。", "variants": ("media-right", "media-left", "default"), "decorations": ("none",)},
    ...
    "photo-gradient": {"use_when": "照片铺满页面并与少量文字自然融合；按主体空白选择文字落在左或右。", "variants": ("copy-left", "copy-right", "default"), "decorations": ("none",)},
    "photo-split": {"use_when": "照片与解释文字权重接近；按阅读顺序选择媒体在左或右。", "variants": ("media-right", "media-left", "default"), "decorations": ("none",)},
    "process-rail": {
    ...
    "editorial-feature": {"use_when": "一张主视觉与三个支撑信息共同解释一个核心判断。", "variants": ("default",), "decorations": ("none",)},
...
VARIANT_QUALITY = {
    "bleed-split": {
        ...
        "default": {"layout_signature": "edge-bleed", "visual_energy": "anchor"},
    },
    "browser-showcase": {
        ...
        "default": {"layout_signature": "browser-split", "visual_energy": "anchor"},
    },
    "cover": {
    ...
    "diagonal-split": {
        ...
        "default": {"layout_signature": "diagonal-bleed", "visual_energy": "anchor"},
    },
    "card-trio": {
    ...
    "photo-gradient": {
        ...
        "default": {"layout_signature": "full-photo-overlay", "visual_energy": "anchor"},
    },
    "photo-split": {
        ...
        "default": {"layout_signature": "balanced-photo-split", "visual_energy": "anchor"},
    },
    "recap": {
    ...
    "split-visual": {
        ...
        "default": {"layout_signature": "inset-split", "visual_energy": "anchor"},
    },
    "three-steps": {
