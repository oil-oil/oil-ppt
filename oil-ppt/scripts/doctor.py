...
def smoke_slides() -> list[dict]:
    ...
    return [
        ...
        {"id": "evidence-matrix", "title": "让每个主张都能回到真实证据", "template": "evidence-matrix", "variant": "default", "decor": "none", "content": "逐项检查公开规范如何支持、质疑或补充页面判断", "claims": [{"id": "perceivable", "title": "内容可感知"}, {"id": "operable", "title": "交互可操作"}, {"id": "semantic", "title": "语义可识别"}], "evidence": [{"id": "wcag", "title": "WCAG 2.2 可访问性准则", "source": {"label": "W3C WCAG 2.2", "url": "https://www.w3.org/TR/WCAG22/"}, "links": [{"claim": "perceivable", "relation": "supports"}, {"claim": "operable", "relation": "supports"}], "note": "原则与成功标准提供直接依据"}, {"id": "aria", "title": "WAI-ARIA 1.2 语义规范", "source": {"label": "W3C WAI-ARIA 1.2", "url": "https://www.w3.org/TR/wai-aria-1.2/"}, "links": [{"claim": "semantic", "relation": "supports"}, {"claim": "operable", "relation": "context"}]}]},
        {"id": "gantt-roadmap", "title": "在有界时间内看清并行推进", "template": "gantt-roadmap", "variant": "default", "decor": "none", "content": "时间段只表达顺序，任务跨度和前置关系由程序转换为版面", "periods": [{"id": "p1", "label": "第 1 周"}, {"id": "p2", "label": "第 2 周"}, {"id": "p3", "label": "第 3 周"}, {"id": "p4", "label": "第 4 周"}, {"id": "p5", "label": "第 5 周"}], "lanes": [{"id": "discovery", "title": "问题发现", "items": [{"id": "collect", "title": "收集事实", "start": "p1", "end": "p1", "note": "形成共同输入"}, {"id": "frame", "title": "界定问题", "start": "p2", "end": "p2", "depends_on": ["collect"]}]}, {"id": "delivery", "title": "方案交付", "items": [{"id": "prototype", "title": "形成方案", "start": "p3", "end": "p3", "depends_on": ["frame"]}, {"id": "verify", "title": "验证结果", "start": "p4", "end": "p5", "depends_on": ["prototype"]}]}, {"id": "enablement", "title": "能力沉淀", "items": [{"id": "document", "title": "整理规范", "start": "p3", "end": "p5", "depends_on": ["frame"]}]}]},
        {"id": "hierarchy-tree", "title": "从一个根节点读出清楚归属", "template": "hierarchy-tree", "variant": "default", "decor": "none", "content": "父子引用只表达语义归属，层级位置与连接线全部由程序生成", "root_id": "system", "nodes": [{"id": "system", "title": "知识系统", "body": "统一入口与治理边界"}, {"id": "inputs", "title": "输入层", "parent": "system"}, {"id": "processing", "title": "处理层", "parent": "system", "body": "把材料转成结构"}, {"id": "outputs", "title": "输出层", "parent": "system"}, {"id": "documents", "title": "文档材料", "parent": "inputs"}, {"id": "records", "title": "结构记录", "parent": "inputs"}, {"id": "reviews", "title": "审阅结果", "parent": "outputs"}]},
