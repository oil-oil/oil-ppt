...
Agent 会根据主题、受众、内容类型和语气自动选择设计方向。可编辑预览顶部只显示一行当前视觉摘要，页面内不再要求我们逐项选择配色、字体和圆角；如果不满意，直接告诉 Agent“更温暖一点”“不要这么圆”或“更像杂志”，它会统一调整整套演示并重新检查全部页面。页面仍支持直接校对文字、自动保存、撤销、重做和还原；完成编辑后会生成新的正式预览，等待再次确认。
